...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
    constructor(json: any) {
        ...
        if (json.geoPointValue !== undefined) {
        ...
        if (json.mapValue !== undefined) {
            this.mapValue = new MapValue(json.mapValue);
        }
        if (json.nullValue !== undefined) {
            this.nullValue = json.nullValue; //[Data format: ]
        }
        if (json.referenceValue !== undefined) {
        ...
        if (json.timestampValue !== undefined) {
